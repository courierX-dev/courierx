...
ActiveRecord::Schema[8.1].define(version: 2026_04_26_170000) do
  ...
  create_table "domain_provider_verifications", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["domain_id", "provider_connection_id"], name: "idx_dpv_on_domain_and_connection", unique: true
    t.index ["domain_id"], name: "index_domain_provider_verifications_on_domain_id"
    t.index ["provider_connection_id"], name: "index_dpv_on_provider_connection_id"
    t.index ["status"], name: "index_domain_provider_verifications_on_status"
  end
  ...
  create_table "provider_quota_usages", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.uuid "provider_connection_id", null: false
    t.datetime "updated_at", null: false
    t.index ["provider_connection_id", "period", "period_start"], name: "idx_pqu_unique_bucket", unique: true
    t.index ["provider_connection_id"], name: "index_provider_quota_usages_on_provider_connection_id"
  end

  create_table "provider_quotas", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "cap_source", default: "manual", null: false
    t.datetime "created_at", null: false
    t.integer "daily_cap"
    ...
    t.uuid "provider_connection_id", null: false
    t.string "reset_strategy", default: "rolling_24h", null: false
    t.datetime "updated_at", null: false
    t.integer "warn_at_pct", default: 80, null: false
    t.index ["provider_connection_id"], name: "index_provider_quotas_on_provider_connection_id", unique: true
  end
  ...
  add_foreign_key "domain_provider_verifications", "provider_connections"
  ...
  add_foreign_key "provider_quota_usages", "provider_connections"
  add_foreign_key "provider_quotas", "provider_connections"
